...
export const MockCourses: ICourse[] = [
    {
        ...
        tags: [
            "Yangi bilimni samarali o'rganish",
            'Websayt nima?',
            'Web-sahifa nima?',
            'Browser nima?',
            'HTML',
        ...
        modules: [
            {
                id: 1,
                title: 'Websayt, Web-sahifa va HTML asoslari',
                module: '1-Modul',
                lessonCount: 3,
                time: '10 daqiqa',
                lessons: [
                    {
                        id: 1,
                        title: 'Kirish. Nima? Nimaga? Qanday?',
                        time: '2 minut',
                        videoUrl: './frontendga-kirish/videos/00.mp4',
                    },
                    {
                        id: 2,
                        title: 'Websayt, Web-sahifa va HTML',
                        time: '2 minut',
                        videoUrl: './frontendga-kirish/videos/01.mp4',
                    },
                    {
                        id: 3,
                        title: 'Html nima o’zi? Tag tushunchasi',
                        time: '2 minut',
                        videoUrl: './frontendga-kirish/videos/02.mp4',
                    },
                ],
                tests: [],
            },
                ...
                tests: [
                    {
                        ...
                        options: [
                            ...
                            {
                                name: 'Muammoni yechish uchun ketma-ket bajariladigan qadamlar to‘plami',
                                isRight: true,
                            },
                            {
                                name: 'Kompyuterning qattiq diskidagi fayl nomi',
                                isRight: false,
                            },
                            {
                                name: 'Faqat grafik shakldagi tuzilma',
                                isRight: false,
                            },
                        ],
                    },
                    {
                        ...
                        options: [
                            ...
                            {
                                name: 'Har qanday ma’lumotlar bilan ishlaydi',
                                isRight: false,
                            },
                            {
                                name: 'Faqat sonli massivlarda ishlaydi',
                                isRight: false,
                            },
                            {
                                name: 'Ma’lumotlar oldindan tartiblangan bo‘lsa',
                                isRight: true,
                            },
                        ],
                    },
                    {
                        ...
                        options: [
                            ...
                            {
                                name: 'Xotiraga yozish va undan o‘qish',
                                isRight: true,
                            },
                    ...
                    },
                    {
                        ...
                        options: [
                            ...
                            {
                                name: 'Ma’lumotlarga ishlov berilmagan ko‘rinish',
                                isRight: false,
                            },
                            {
                                name: 'Maqsadli, foydali ma’lumot',
                                isRight: true,
                            },
                            {
                                name: 'Har qanday raqamli ma’lumot',
                                isRight: false,
                            },
                        ],
                    },
                    {
                        ...
                        options: [
                            {
                                name: 'Xotira faqat diskda bo‘ladi',
                                isRight: false,
                            },
                            {
                                name: 'Ma’lumotlar ishlov berishdan oldin bo‘ladi',
                                isRight: false,
                            },
                            {
                                name: 'Ma’lumotlar doimiy, xotira esa vaqtincha',
                                isRight: true,
                            },
                ...
                tests: [
                    {
                        ...
                        options: [
                            {
                                name: 'Faqat matnli fayl yaratish',
                                isRight: false,
                            },
                            {
                                name: 'Kompyuter uchun buyruqlar yozish jarayoni',
                                isRight: true,
                            },
                            {
                                name: 'Internetda saytlarga kirish',
                                isRight: false,
                            },
                    ...
                    },
                    {
                        ...
                        options: [
                            ...
                            {
                                name: 'Dastur xatolarini tuzatish',
                                isRight: false,
                            },
                        ],
                    },
                    {
                        ...
                        options: [
                            {
                                name: 'Tarmoq sozlamalarini o‘zgartirish',
                                isRight: false,
                            },
                            {
                                name: 'Kompyuter bilan so‘zlashish uchun vosita',
                                isRight: true,
                            },
                    ...
                    },
                    {
                        ...
                        options: [
                            {
                                name: 'Faqat ijtimoiy tarmoqlar',
                                isRight: false,
                            },
                            { name: 'Kompyuter o‘yinlari', isRight: false },
                            {
                                name: 'Internet orqali ko‘rinadigan hujjat va xizmatlar to‘plami',
                                isRight: true,
                            },
                ...
                tests: [
                    {
                        ...
                        options: [
                            ...
                            {
                                name: 'Ma’lumotni boshqa ko‘rinishga o‘zgartirish',
                                isRight: true,
                            },
                    ...
                    },
                    {
                        ...
                        options: [
                            {
                                name: 'Rasm sifatini yaxshilash',
                                isRight: false,
                            },
                            { name: 'Ma’lumotni himoya qilish', isRight: true },
                            {
                                name: 'Internet tezligini oshirish',
                                isRight: false,
                            },
                            {
                                name: 'Video faylni qisqartirish',
                                isRight: false,
                            },
                        ],
                    },
                    {
                        ...
                        options: [
                            ...
                            {
                                name: 'Faqat xavfsizlik darajasi',
                                isRight: false,
                            },
                            {
                                name: 'Ma’lumotlar bazasi sig‘imi',
                                isRight: false,
                            },
                        ],
                    },
                    {
                        ...
                        options: [
                            {
                                name: 'Kompyuter tezroq ishlashi uchun',
                                isRight: false,
                            },
                            {
                                name: 'Dasturlash tili osonroq bo‘lishi uchun',
                                isRight: false,
                            },
                            {
                                name: 'Ma’lumotlar o‘g‘irlanmasligi uchun',
                                isRight: true,
                            },
                            {
                                name: 'Internet tezligi oshishi uchun',
                                isRight: false,
                            },
                        ],
                    },
                    {
                        ...
                        options: [
                            ...
                            {
                                name: 'Murakkab, harflar va belgilar aralashgan',
                                isRight: true,
                            },
                ...
                tests: [
                    ...
                    },
                    {
                        ...
                        options: [
                            ...
                            {
                                name: 'HTML va TypeScript bilan interfeysni tashkil qiluvchi birlik',
                                isRight: true,
                            },
                    ...
                    },
                    {
                        ...
                        options: [
                            ...
                            {
                                name: 'Component ichida CSS yozish uchun',
                                isRight: false,
                            },
                            {
                                name: 'HTML elementdagi hodisalarga javob berish uchun',
                                isRight: true,
                            },
                    ...
                    },
                    {
                        ...
                        options: [
                            ...
                            {
                                name: "Componentlar o'rtasida ma'lumot almashish uchun",
                                isRight: true,
                            },
                            {
                                name: 'HTML faylni ochish uchun',
                                isRight: false,
                            },
                            {
                                name: 'Angular CLI yangilash uchun',
                                isRight: false,
                            },
                        ],
                    },
                    {
                        ...
                        options: [
                            ...
                            {
                                name: 'Sahifalar o‘rtasida harakatni boshqaradi',
                                isRight: true,
                            },
                ...
                tests: [
                    {
                        ...
                        options: [
                            {
                                name: "Sahifalar o'rtasida o'tish uchun",
                                isRight: true,
                            },
                    ...
                    },
                    {
                        ...
                        options: [
                            {
                                name: 'Hammasini bir zumda yuklash',
                                isRight: false,
                            },
                            {
                                name: 'Faqat kerakli sahifani yuklash',
                                isRight: true,
                            },
                            {
                                name: 'Barcha ma’lumotlarni keshga yozish',
                                isRight: false,
                            },
                    ...
                    },
                    {
                        ...
                        options: [
                            ...
                            {
                                name: 'Formani DOM orqali boshqaradi',
                                isRight: false,
                            },
                            {
                                name: 'Formani dastur orqali boshqarish va tekshiruvlar',
                                isRight: true,
                            },
                    ...
                    },
                    {
                        ...
                        options: [
                            ...
                            {
                                name: 'Angularning UI komponenti',
                                isRight: false,
                            },
                        ],
                    },
                    {
                        ...
                        options: [
                            ...
                            {
                                name: 'Angular uchun UI komponentlar kutubxonasi',
                                isRight: true,
                            },
                ...
                tests: [
                    {
                        ...
                        options: [
                            ...
                            {
                                name: 'Create, Render, Upload, Debug',
                                isRight: false,
                            },
                            {
                                name: 'CSS, Routing, UI, Database',
                                isRight: false,
                            },
                        ],
                    },
                    {
                        ...
                        options: [
                            ...
                            {
                                name: "Ma'lumotlar almashishni HTTP orqali amalga oshiradi",
                                isRight: true,
                            },
                    ...
                    },
                    {
                        ...
                        options: [
                            {
                                name: 'FormGroup va FormControl orqali boshqariladi',
                                isRight: true,
                            },
                            { name: 'DOM asosida ishlaydi', isRight: false },
                            {
                                name: 'Faqat HTML orqali boshqariladi',
                                isRight: false,
                            },
                            {
                                name: 'Routing uchun ishlatiladi',
                                isRight: false,
                            },
                        ],
                    },
                ...
                tests: [
                    ...
                    },
                    {
                        ...
                        options: [
                            ...
                            {
                                name: 'Komponentlarni kiritish usuli',
                                isRight: false,
                            },
                            {
                                name: 'Ma’lumotni o‘zgartirishda foydalaniladigan vosita',
                                isRight: true,
                            },
                    ...
                    },
                    {
                        ...
                        options: [
                            ...
                            {
                                name: 'Shartli kontent ko‘rsatish uchun',
                                isRight: true,
                            },
                            { name: 'Service yaratish uchun', isRight: false },
                    ...
                    },
                    {
                        ...
                        options: [
                            {
                                name: 'Contentni tashqi componentdan chiqarib beradi',
                                isRight: true,
                            },
                    ...
                    },
                    {
                        ...
                        options: [
                            ...
                            {
                                name: 'Angularning hujjatlari va misollarini o‘rganish uchun',
                                isRight: true,
                            },
                            { name: 'Veb dizayn qilish uchun', isRight: false },
                            {
                                name: 'Angular testlarini tekshirish uchun',
                                isRight: false,
                            },
                        ],
                    },
                ...
                tests: [
                    {
                        ...
                        options: [
                            {
                                name: 'Tanlab oluvchining ustunligi',
                                isRight: true,
                            },
                    ...
                    },
                    {
                        ...
                        options: [
                            ...
                            {
                                name: 'Div elementlarida har doim',
                                isRight: false,
                            },
                            { name: 'Faqat script bilan', isRight: false },
                            {
                                name: 'class nomi bir xil bo‘lsa',
                                isRight: false,
                            },
                        ],
                    },
                    {
                        ...
                        options: [
                            {
                                name: 'Elementlar orasidagi aloqani bildiradi',
                                isRight: true,
                            },
                    ...
                    },
                    {
                        ...
                        options: [
                            {
                                name: 'Class takrorlansa bo‘ladi, ID – yo‘q',
                                isRight: true,
                            },
                            { name: 'ID matnga tegishli', isRight: false },
                            {
                                name: 'Class faqat bir marta ishlatiladi',
                                isRight: false,
                            },
                ...
                tests: [
                    {
                        ...
                        options: [
                            ...
                            {
                                name: 'Container, Box, Line, Space',
                                isRight: false,
                            },
                            {
                                name: 'Block, Inline, Grid, Flex',
                                isRight: false,
                            },
                            {
                                name: 'Text, Image, Video, Link',
                                isRight: false,
                            },
                        ],
                    },
                    {
                        ...
                        options: [
                            {
                                name: 'Element tashqarisidagi bo‘shliqni beradi',
                                isRight: true,
                            },
                            {
                                name: 'Element ichidagi bo‘shliq',
                                isRight: false,
                            },
                    ...
                    },
                    {
                        ...
                        options: [
                            ...
                            {
                                name: 'Element atrofidagi chekka',
                                isRight: false,
                            },
                            {
                                name: 'Rasmga o‘lcham beruvchi qiymat',
                                isRight: false,
                            },
                    ...
                    },
                    {
                        ...
                        options: [
                            {
                                name: 'Element maksimal kengligini',
                                isRight: true,
                            },
                            {
                                name: 'Matn maksimal balandligini',
                                isRight: false,
                            },
        ...
        modules: [
            {
                ...
                tests: [
                    ...
                    },
                    {
                        ...
                        options: [
                            {
                                name: 'Foydalanuvchi interfeysini yaratadi',
                                isRight: true,
                            },
                            {
                                name: 'Backend dasturlash qiladi',
                                isRight: false,
                            },
                            {
                                name: 'Foydalanuvchi maʼlumotlarini saqlaydi',
                                isRight: false,
                            },
                            {
                                name: 'Maʼlumotlar bazasini boshqaradi',
                                isRight: false,
                            },
                        ],
                    },
                    {
                        ...
                        options: [
                            {
                                name: 'Tugma, matn oynasi, ranglar',
                                isRight: true,
                            },
                            { name: "Ma'lumotlar bazasi", isRight: false },
                    ...
                    },
                    {
                        ...
                        options: [
                            {
                                name: 'Koʻrish qulayligini oshiradi',
                                isRight: true,
                            },
                            { name: 'Kodni tez ishlatadi', isRight: false },
                            {
                                name: 'Tizim xavfsizligini taʼminlaydi',
                                isRight: false,
                            },
                            {
                                name: 'Video tezligini oshiradi',
                                isRight: false,
                            },
                        ],
                    },
                    {
                        ...
                        options: [
                            ...
                            {
                                name: "Ma'lumotlar xavfsizligini taʼminlaydi",
                                isRight: false,
                            },
                            {
                                name: 'Server yuklamasini kamaytiradi',
                                isRight: false,
                            },
                            {
                                name: 'Kompilyatsiya tezligini oshiradi',
                                isRight: false,
                            },
                        ],
                    },
            ...
            },
            {
                ...
                tests: [
                    ...
                    },
                    {
                        ...
                        options: [
                            {
                                name: 'Foydalanuvchi tajribasini yaxshilash',
                                isRight: true,
                            },
                    ...
                    },
                    {
                        ...
                        options: [
                            ...
                            {
                                name: 'Server yuklamasini tahlil qilish uchun',
                                isRight: false,
                            },
                            {
                                name: 'Mobil ilova o‘lchamini kamaytirish uchun',
                                isRight: false,
                            },
                            {
                                name: 'Kod uzunligini aniqlash uchun',
                                isRight: false,
                            },
                        ],
                    },
                    {
                        ...
                        options: [
                            {
                                name: 'Foydalanuvchining ehtiyojini tushunish',
                                isRight: true,
                            },
                            {
                                name: 'Fayl nomlarini belgilash',
                                isRight: false,
                            },
                    ...
                    },
                    {
                        ...
                        options: [
                            {
                                name: 'UX - tajriba, UI - interfeys',
                                isRight: true,
                            },
                            {
                                name: 'UX - interfeys, UI - tajriba',
                                isRight: false,
                            },
                ...
                tests: [
                    {
                        ...
                        options: [
                            {
                                name: 'Dizayn va prototiplash uchun',
                                isRight: true,
                            },
                            {
                                name: 'Kod kompilyatsiyasi uchun',
                                isRight: false,
                            },
                            {
                                name: 'Maʼlumotlar bazasini boshqarish uchun',
                                isRight: false,
                            },
                    ...
                    },
                    {
                        ...
                        options: [
                            {
                                name: 'Bir xil elementlarni qayta ishlatish uchun',
                                isRight: true,
                            },
                            { name: 'Serverni sozlash uchun', isRight: false },
                            {
                                name: 'Kod optimallashtirish uchun',
                                isRight: false,
                            },
                    ...
                    },
                    {
                        ...
                        options: [
                            {
                                name: "Interaktiv dizaynni ko'rsatish",
                                isRight: true,
                            },
                            { name: 'Kod yozish', isRight: false },
                            { name: 'Ma’lumotlarni saqlash', isRight: false },
                            {
                                name: 'Serverni ishga tushirish',
                                isRight: false,
                            },
                        ],
                    },
                    {
                        ...
                        options: [
                            {
                                name: 'Ranglar, shriftlar, joylashuvni belgilaydi',
                                isRight: true,
                            },
                            {
                                name: 'Maʼlumotlarni tahlil qiladi',
                                isRight: false,
                            },
